    ...
    <form action="{{ route('admin.pengaturan-lan.update', $ip->id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="nama_jaringan" value="{{ old('nama_jaringan', $ip->nama_jaringan) }}" required class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#F08600] focus:border-[#F08600] outline-none transition-all">
            </div>
            ...
            <div>
                ...
                <input type="text" name="ip_address" value="{{ old('ip_address', $ip->ip_address) }}" required class="w-full font-mono border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#F08600] focus:border-[#F08600] outline-none transition-all text-orange-700 bg-orange-50/30">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="keterangan" rows="3" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#F08600] focus:border-[#F08600] outline-none transition-all">{{ old('keterangan', $ip->keterangan) }}</textarea>
            </div>
        </div>
